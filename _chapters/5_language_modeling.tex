...
\begin{note}{}
    ...
    However, most research teams that produce state-of-the-art language models do not share their training sets (usually due to legal reasons).
\end{note}
...
\textbf{Training is self-supervised} since the dataset contains all $k$-grams whose target is the subsequent word. The loss function is cross-entropy.
